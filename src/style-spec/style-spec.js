...
type ExpressionParameters = Array<'zoom' | 'feature' | 'feature-state' | 'heatmap-density' | 'line-progress' | 'slope-progress' | 'sky-radial-progress' | 'pitch' | 'distance-from-center'>;
